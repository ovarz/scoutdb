...
<div class="rancak-container">
  <span class="width-max">
    ...
    <section aria-label="Breadcrumb" class="breadcrumb">
      ...
      <a aria-label="<?php echo $practice_type; ?>" title="<?php echo $practice_type; ?>" class="breadcrumb-link content_center" href="practice/team/player/<?php echo $practice_type; ?>/">
