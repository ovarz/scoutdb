  ...
  <span class="width-max">
    ...
    <section aria-label="Section Competition" class="section-container">
	  <h2 class="section-title">
        ...
        <div class="section-title-label">Home Team Name Lineup</div>
	  </h2>
      ...
      <div class="match-info-row match-info-submit">
        <button class="btn content_center" onclick="location.href='competition/in-game-administration/info/lineup-home-filled.php';">
          Save Data
        </button>
      </div>
    </section>
